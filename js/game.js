...
person.prototype={
    draw:function(){
        ...
        this.cobj.drawImage(this[this.status][this.state],0,0,1000,600,0,0,this.width,this.height);
        this.cobj.restore();
    }
};
...
game.prototype={
    ...
    zhezhao:function(){
        ...
        mask.click(function(){
            ...
            that.zobj.y=that.person.y+that.person.height/2-130;
